...
@Composable
fun HomeScreen(retryAction: () -> Unit, marsUiState: MarsUiState, modifier: Modifier = Modifier) {
    when (marsUiState) {
...
@Composable
fun PhotosGridScreen(modifier: Modifier = Modifier, photos: List<MarsPhoto>){
    LazyVerticalGrid(
